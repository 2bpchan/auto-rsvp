...
- **Asterisks are stripped** - markdown-style `*emphasis*`/`**bold**` markers are deleted outright rather than displayed or counted toward the slowdown above, since they're pure visual clutter for a reader
